...
| Notion | **Obsidian**（免费非开源）/ **Joplin** | 本地笔记更容易自己备份；Notion 本身也有[教育优惠](./tech-student-pack.md) |
...
| Premiere | **DaVinci Resolve**（免费版）/ **Shotcut** | DaVinci 免费版已经能覆盖多数入门剪辑需求 |
...
| Xshell / SecureCRT | **Windows Terminal + OpenSSH** / **Tabby** | Termius Pro 也在 GitHub 学生包里 |
...
| Everything（本身免费） | —— | Windows 下常用的本地文件搜索工具 |
| TeamViewer | **RustDesk** | 开源远程桌面，可自建中继（见[自托管入门](./tech-self-hosting.md)） |
| 各类录屏软件 | **OBS Studio** | 常用的录屏 / 直播工具 |
