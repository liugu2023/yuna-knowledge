...
> **核验说明**
>
> 本页入口核验于 2026 年 7 月 10 日。登录后的校内规则，请以当前系统、当学期通知和本人培养方案为准。
...
在成绩查询或`我的学分绩点`页面，可以查看系统当前提供的成绩和统计字段。评教是否影响成绩显示、评教截止时间及能否补评，应以当学期教务通知和系统提示为准。
...
页面展示方式可能变化。核对毕业要求时，应确认培养方案对应自己的入学年级和专业，不要套用其他年级版本。
...
系统可用于查看和预约当前开放的座位或研讨间。预约开放时间、签到期限、暂离时长、取消规则、积分与违约处理可能调整，公开页面无法确认固定数字。
