...
-  两个坑：免费层的数据会被 Google 用于改进产品（勿传敏感内容）；2025 年 12 月 Google 曾无预告大砍免费额度（Flash 日请求数从约 250 次降到 20~50 次），额度随时可能再变
...
3. **做好 fallback**：一个平台挂了自动切下一个（可配合 [cc-switch](./tech-cc-switch.md) 或网关类工具管理多个供应商）
